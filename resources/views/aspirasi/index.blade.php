                ...
                <table 
                    ...
                    <tr>
                        ...
                        <div class="button-container">
                            ...
                            <a href="{{ route('aspirasi.edit', $aspirasi->id_pengajuan_aspirasi) }}" class="ri-question-mark"></a>
                            @endif
                            @if ($aspirasi->status == 'Direvisi')
                            <a href="{{ route('aspirasi.edit', $aspirasi->id_pengajuan_aspirasi) }}" class="ri-close-circle-line edit"></a>
                            @endif
