                            ...
                            <thead>
                                ...
                                @foreach ($ppid as $w)
                                    <tr>
                                        ...
                                        @if ($w->status == 'Revisi1')
                                            <td><span><a class="rejected"
                                                        href="/ppid/{{ $w->id }}/revisi">keberatan</a></span>
                                            </td>
                                        @endif

                                        <td><span><a class="ri-edit-line edit"
                                                    href="/ppid/{{ $w->id }}/edit">Detail</a></span>
                                        <td><span><a class="ri-edit-line edit" href="/ppid/{{ $w->id }}/export"
                                                    target="_blank">Export</a></span>
                                            <span>
                                                <button class="ri-delete-bin-line delete" data-bs-toggle="modal"
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Data
                                                                    akan dihapus secara permanen</h1>
                                                            </div>
                                                            <div class="modal-body">
                                                                Apakah Anda yakin ingin menghapus data?
                                                            </div>
                                                            <div class="modal-footer">
                                                                <form action="{{ route('ppid.destroy', $w->id) }}"
